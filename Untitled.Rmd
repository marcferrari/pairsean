...
Through the lm function, we can find the coefficients of our linear regression model.
...
With this our linear regression model is as follows:

<center>

$\hat y = 238.5569   +    0.3339x_1   +  (-2.7167)x_2$
